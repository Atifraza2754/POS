    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                ...
                {{-- <a href="#" id="download-full-payment-pdf" class="mx-2 btn btn-success btn-sm">
                    <i class="bx bxs-file-pdf"></i> Download Full PDF
                </a> --}}
                ...
                <div class="modal-body row g-3">
                    <div class="mb-0">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4 col-lg-6">
                                <a href="#" id="download-full-payment-pdf" class="mx-2 btn btn-primary btn-sm">
                                    <i class="bx bxs-file-pdf"></i> Download Full PDF
                                </a>
                            </div>
                        </div>
