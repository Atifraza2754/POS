...
@section('title', __('order.create'))
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="row">
                    <form class="row g-3 needs-validation" method="POST" action="{{ route('purchase.payment.store') }}" enctype="multipart/form-data">
                        {{-- CSRF Protection --}}
                        @csrf
                        ...
                        <div class="col-12 col-lg-12">
                            <div class="card">
                                <div class="card-header px-4 py-3">
                                    <h5 class="mb-0">Create Purchase Payment</h5>
                                </div>
                                ...
                                @endif
                                        <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select single-select-clear-field" id="supplier_id" name="supplier_id" data-placeholder="Choose Suppluer">
                                                        <option></option>
...
$(document).ready(function () {
    $('#supplier_id').on('change', function () {
        ...
        if (!supplierId) return; // guard clause

        $.ajax({
            url: '{{ route("get.supplier.orders") }}', // Laravel route
            method: 'GET',
            data: { supplier_id: supplierId },
            success: function (response) {
                $('#supplier-orders').html(response.html); // assuming you're returning HTML
            },
            error: function (xhr) {
                console.error(xhr.responseText);
                $('#supplier-orders').html('<p class="text-danger">Failed to fetch orders.</p>');
            }
        });
    });
});
