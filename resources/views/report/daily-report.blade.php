@extends('layouts.app')
@section('title', __('Cash In Report'))
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="row">
                    <form class="row g-3 needs-validation" id="dailyReportForm" action="{{ route('report.daily.ajax') }}" enctype="multipart/form-data">
                        {{-- CSRF Protection --}}
                        @csrf
                        @method('POST')
                        ...
                        <div class="col-12 col-lg-12">
                            <div class="card">
                                <div class="card-header px-4 py-3">
                                    <h5 class="mb-0">{{ __('Daily Report') }}</h5>
                                </div>
                                <div class="card-body p-4 row g-3">
                                    
                                        <div class="col-md-6 mb-3">
                                            <x-label for="from_date" name="Select the Date" />
                                            <div class="input-group">
                                                <x-input type="text" additionalClasses="datepicker" name="date" :required="true" value=""/>
...
@section('js')
    ...
    <script src="{{ asset('custom/js/reports/daily-report.js') }}"></script>
