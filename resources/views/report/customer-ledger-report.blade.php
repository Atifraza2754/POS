...
@section('title', __('Ledger Report'))
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="row">
                    <form class="row g-3 needs-validation" id="customerLedgerReportForm" action="{{ route('report.customer-ledger.ajax') }}" enctype="multipart/form-data">
                        {{-- CSRF Protection --}}
                        @csrf
                        @method('POST')
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-4 row g-3">
                                        <div class="col-md-12 table-responsive">
                                            ...
                                            <table class="table table-bordered" id="customerLedgerReport">
                                                <thead>
...
@section('js')
    ...
    <script src="{{ asset('custom/js/reports/customer-ledger.js') }}"></script>
