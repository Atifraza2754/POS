...
@section('title', __('Ledger Report'))
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="row">
                    <form class="row g-3 needs-validation" id="ledgerReportForm" action="{{ route('report.ledger.ajax') }}" enctype="multipart/form-data">
                        {{-- CSRF Protection --}}
                        @csrf
                        @method('POST')
...
@section('js')
    ...
    <script src="{{ asset('custom/js/reports/ledger-list.js') }}"></script>
