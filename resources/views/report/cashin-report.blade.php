...
@section('title', __('Cash In Report'))
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="row">
                    <form class="row g-3 needs-validation" id="cashinReportForm" action="{{ route('report.cashin.ajax') }}" enctype="multipart/form-data">
                        {{-- CSRF Protection --}}
                        @csrf
                        @method('POST')
                        ...
                        <div class="col-12 col-lg-12">
                            <div class="card">
                                <div class="card-header px-4 py-3">
                                    <h5 class="mb-0">{{ __('Cash In Report') }}</h5>
                                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-4 row g-3">
                                        <div class="col-md-12 table-responsive">
                                            <table class="table table-bordered" id="cashinReport">
                                                <thead>
...
@section('js')
    ...
    <script src="{{ asset('custom/js/reports/cashin.js') }}"></script>
