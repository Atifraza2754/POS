...
@section('title', __('sale.sale_report'))
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="row">
                    <form class="row g-3 needs-validation" id="reportForm" action="{{ route('report.customer-total-sale.ajax') }}" enctype="multipart/form-data">
                        {{-- CSRF Protection --}}
                        @csrf
                        @method('POST')
                        ...
                        <div class="col-12 col-lg-12">
                            <div class="card">
                                <div class="card-header px-4 py-3">
                                    <h5 class="mb-0">{{ __('Customer Total Sales Report ') }}</h5>
                                </div>
...
@section('js')
    ...
    <script src="{{ asset('custom/js/reports/customer-total-sale.js') }}"></script>
