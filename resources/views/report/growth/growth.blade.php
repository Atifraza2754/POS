...
@section('title', 'Growth Report')
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="row">
                    <form class="row g-3 needs-validation" id="reportForm" action="{{ route('report.growth.ajax') }}" enctype="multipart/form-data">
                        {{-- CSRF Protection --}}
                        @csrf
                        @method('POST')
                        ...
                        <div class="col-12 col-lg-12">
                            <div class="card">
                                <div class="card-header px-4 py-3">
                                    <h5 class="mb-0">Growth Report</h5>
                                </div>
                                                    ...
                                                    <table id="reportTable" class="table table-bordered table-hover">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td id="stock_value" class='text-end' data-tableexport-celltype="number">0.00</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-center">2</td>
                                                                <td>Total Due On Customer</td>
                                                                <td id="due_on_customer" class='text-end' data-tableexport-celltype="number">0.00</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-center">3</td>
                                                                <td>Total Purchase Supplier Balance</td>
                                                                <td id="purchase_supplier_balance" class='text-end' data-tableexport-celltype="number">0.00</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-center">4</td>
                                                                <td>Cash In Hand</td>
                                                                <td id="cash_in_hand" class='text-end' data-tableexport-celltype="number">0.00</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-center">5</td>
                                                                <td>Total Profit</td>
                                                                <td id="total_profit" class='text-end' data-tableexport-celltype="number">0.00</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
...
<script src="{{ asset('custom/js/reports/growth/growth.js') }}"></script>
