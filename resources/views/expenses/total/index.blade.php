        ...
        <div class="page-wrapper">
            <div class="page-content">
                    ...
                    <div class="card-header px-4 py-3 d-flex justify-content-between">
                        ...
                        <div>
                            <h5 class="mb-0 text-uppercase">{{ __('Cash Out') }}</h5>
                        </div>
                    ...
                    <div class="card-body">
                     ...
                     <div class="card-body">
                        ...
                        <form class="row g-3 needs-validation" id="datatableForm" action="{{ route('expense.delete') }}" enctype="multipart/form-data">
                            ...
                            @method('POST')
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered border w-100" id="supplier-datatable">
                                    <thead>
                                        <tr>
                                            <th class="d-none"><!-- Which Stores ID & it is used for sorting --></th>
                                            <th><input class="form-check-input row-select" type="checkbox"></th>
...
<script src="{{ asset('custom/js/expenses/total-expense-list.js') }}"></script>
<script src="{{ asset('custom/js/expenses/supplier-expense-list.js') }}"></script>
@endsection
