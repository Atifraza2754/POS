...
Route::middleware('auth')->group(function () {
    ...
    Route::group(['prefix' => 'report'], function () {
        ...
        Route::post('/ledger/get-records', [LedgerReportController::class, 'getLedgerRecords'])->name('report.ledger.ajax');
        ...
        Route::get('/ledger', [LedgerReportController::class,'index'])->name('report.ledger.page');
        Route::get('/ledger-list', [LedgerReportController::class,'ledgerListDatatable']);

        Route::get('/customer-ledger-page', [LedgerReportController::class,'customerLedger'])->name('report.customer.ledger.page');
        Route::post('/customer-ledger-report', [LedgerReportController::class,'customerLedgerReport'])->name('report.customer-ledger.ajax');


        Route::get('/daily', [ReportsController::class,'DailyReportPage'])->name('report.daily.page');
        Route::post('/daily-data', [ReportsController::class,'DailyReportData'])->name('report.daily.ajax');


        Route::get('/customer-total', [ReportsController::class,'customerTotalSalePage'])->name('report.customer-total.page');
        Route::post('/customer-total-sale-report', [ReportsController::class,'customerTotalSaleReport'])->name('report.customer-total-sale.ajax');

        Route::get('/stock', [ReportsController::class,'stockReportPage'])->name('report.stock.page');
        Route::post('/stock/get-records', [ReportsController::class, 'getStockRecords'])->name('report.stock.ajax');

        Route::get('/cash-in', [ReportsController::class,'cashInReportPage'])->name('report.cashin.page');
        Route::post('/cash-in/get-records', [ReportsController::class, 'getCashinRecords'])->name('report.cashin.ajax');
    ...
    Route::group(['prefix' => 'purchase'], function () {
        ...
        Route::get('/payment/create', [PurchaseOrderPaymentController::class, 'purchasePaymentPage'])
                ->name('purchase.payments.create');

        });

        Route::get('/get-supplier-orders', [PurchaseOrderPaymentController::class, 'getSupplierOrders'])->name('get.supplier.orders');//View
        Route::post('/store', [PurchaseOrderPaymentController::class, 'supplierOrdersPaymentStore'])->name('purchase.payment.store');//View
        Route::get('/supplier/{id}/advance', [PurchaseOrderPaymentController::class, 'advanceBalance']);

        Route::post('purchase/return/direct', [PurchaseReturnController::class, 'directReturn'])
        ->name('purchase.return.direct');

        Route::get('purchase/return', [PurchaseReturnController::class, 'purchaseReturn'])
        ->name('purchase.return');

        // Route::get('purchase/return/datatable-list', [PurchaseReturnController::class, 'purchaseReturnDatatableList']);
    ...
    Route::group(['prefix' => 'payment/'], function () {
         ...
         * */
        //get Payment details
        Route::get('/{type}/history-pdf/{invoiceId}', [PurchasePaymentController::class, 'downloadFullPaymentPdf']);
